...
def showimage():
    ...
    #print(filename)
    file_in_bytestream = open(filename.name, 'rb')
    img = Image.open(file_in_bytestream)
...
# icon
image_icon = ImageTk.PhotoImage(file=r"C:\\Users\\vignesh.jayalakshmi\\Downloads\\logo.jpg")
root.iconphoto(False, image_icon)

# logo
logo = PhotoImage(file=r"C:\\Users\\vignesh.jayalakshmi\\Downloads\\logo.png")
